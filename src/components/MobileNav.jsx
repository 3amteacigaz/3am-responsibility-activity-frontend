              ...
              {user?.userType === 'core' ? (
                <>
                  ...
                  <Link 
                    ...
                    className={`mobile-menu-item ${isActive('/manage-activities') ? 'active' : ''}`}
                    onClick={closeMenu}
                  >
                  ...
                  <Link 
                    to="/activities" 
                    className={`mobile-menu-item ${isActive('/activities') ? 'active' : ''}`}
                    onClick={closeMenu}
                  >
                ...
                <>
                  ...
                  <Link 
                    to="/presence" 
                    className={`mobile-menu-item ${isActive('/presence') ? 'active' : ''}`}
                    onClick={closeMenu}
                  >
